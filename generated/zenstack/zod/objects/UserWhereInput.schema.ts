...
import { SpaceListRelationFilterObjectSchema } from './SpaceListRelationFilter.schema';
...
export const UserWhereInputObjectSchema: SchemaType = z.object({
    ...
    z.union([z.date(), z.string().datetime().optional()])]).optional(), email: z.union([z.lazy(() => StringFilterObjectSchema),
    z.string()]).optional(), emailVerified: z.union([z.lazy(() => DateTimeNullableFilterObjectSchema),
    ...
    z.string(),
    z.null()]).optional().nullable(), ownedSpaces: z.lazy(() => SpaceListRelationFilterObjectSchema).optional().optional(), memberships: z.lazy(() => SpaceUserListRelationFilterObjectSchema).optional().optional(), lists: z.lazy(() => ListListRelationFilterObjectSchema).optional().optional(), todos: z.lazy(() => TodoListRelationFilterObjectSchema).optional().optional(), accounts: z.lazy(() => AccountListRelationFilterObjectSchema).optional().optional()
