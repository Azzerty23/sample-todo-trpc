 ...
 * @private
 */
export const AccountPrismaCreateSchema = baseSchemaWithoutDefaults.partial().passthrough();
...
export const AccountPrismaUpdateSchema = z.object({
    ...
    providerAccountId: z.string(),
    refresh_token: z.string().nullish(),
    refresh_token_expires_in: z.union([z.number().nullish(), z.record(z.string(), z.unknown())]),
    access_token: z.string().nullish(),
    expires_at: z.union([z.number().nullish(), z.record(z.string(), z.unknown())]),
    token_type: z.string().nullish(),
    scope: z.string().nullish(),
    id_token: z.string().nullish(),
    session_state: z.string().nullish()
 ...
 */
export const AccountCreateScalarSchema = baseSchemaWithoutDefaults.partial({
    id: true
});
 ...
 */
export const AccountUpdateScalarSchema = baseSchemaWithoutDefaults.partial();
